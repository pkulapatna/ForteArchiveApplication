...
namespace ForteArchives.ViewModels
{
    public class MainWindowViewModel : BindableBase
    {

        protected readonly Prism.Events.IEventAggregator _eventAggregator = new Prism.Events.EventAggregator();
        ...
        private string _title = "Forte Archives Application";
        public string Title
        {
            get { return _title; }
        ...
        public DelegateCommand SetupCommand =>
            _setupCommand ?? (_setupCommand = new DelegateCommand(SetupCommandExecute));
        private void SetupCommandExecute()
        {

            if (SetUpWindow != null) SetUpWindow = null;
            ...
            SetUpWindow.ResizeMode = ResizeMode.NoResize;
            SetUpWindow.Show();
